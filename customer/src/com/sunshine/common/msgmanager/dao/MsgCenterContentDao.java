 ...
 * @Version: 1.0
 */
public interface MsgCenterContentDao extends BaseDao<MsgCenterContent, String> {
	/**
	 * 根据个人中心消息ID删除
	 * @param msgId
	 */
	 ...
	 * @param msgId
	 */
	public abstract List<MsgCenterContent> findByMsgId(String msgId);
}
...
public class LoginController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/pf_toLogin", method = RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/pf_doLogin", method = { RequestMethod.POST, RequestMethod.GET })
	public ModelAndView doLogin(RedirectAttributes redirectAttributes, HttpServletRequest request) throws Exception {
		...
		String msg = null;
		try {
			UsernamePasswordToken token = new UsernamePasswordToken(userAccount, MD5Utils.getMd5String16(password));

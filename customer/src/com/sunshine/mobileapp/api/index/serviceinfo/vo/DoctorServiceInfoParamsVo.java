 ...
 * </html>
 */
package com.sunshine.mobileapp.api.index.serviceinfo.vo;
...
/**
* @Package：com.sunshine.mobileapp.api.index.serviceinfo.vo   
* @ClassName：DoctorServiceInfoParamsVo   
* @Description：   <p> TODO</p>
* @Author： - DaoDou 
* @CreatTime：2017年9月8日 上午11:06:40   
* @Modify By：   
* @ModifyTime：  
* @Modify marker：   
* @version    V1.0
...
public class DoctorServiceInfoParamsVo<T> extends BaseSQLEntity implements Serializable {

...
<div id="header">
    <div class="logo">
         <p class="logo-pic"><img class="img-circle" src="${basePath}/platform/images/logo.png"></p>
    ...
    <div class="header-tit">
        ...
        <div class="avatar dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="${basePath}/pf_logout"><i class="icon icon-quit"></i>退出登录</a></li>
            </ul>
        </div>
    </div>
</div>

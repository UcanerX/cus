...
<head>
    ...
    <title>登录</title>
    <script type="text/javascript" src="${basePath}/platform/js/jquery-1.12.3.min.js?v=${js_version}"></script>
    <link rel="stylesheet" href="${basePath}/platform/css/login.css?v=${css_version}"/>
</head>
<body> 
<div class="login">
	 <!-- 
     <h1 class="h1-tit"><img src="${basePath}${application.pfLoginLogoPath}" alt="${application.name}"><span>平台</span></h1>
     -->
     <div class="con ">   
          <form id="loginForm" action="${basePath}/pf_doLogin" method="post">
